...
REVIEW_REPORT = {
    ...
    "summary": {"total_issues": 3, "critical": 0, "high": 1, "medium": 2, "low": 0, "issue_types": 2},
    "issues": [
        {
            "code": "format_value_mismatch",
            "level": "high",
            "title": "格式与模板要求不一致",
            "suggestion": "请套用模板样式，并清除手动设置的格式。",
            "location": "第2章 系统设计 · 第1段 等 2 处",
            "locations": ["第2章 系统设计 · 第1段", "第2章 系统设计 · 第3段"],
            "count": 2,
        },
        {
            ...
            "level": "medium",
            "title": "表格缺少题注",
            "suggestion": "请在表格上方添加题注。",
            "location": "第3章 部署 · 第1张表格",
            "locations": ["第3章 部署 · 第1张表格"],
            "count": 1,
        },
    ],
